  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO
        ...
        description={`How ${SITE_PUBLISHER} collects, uses, and protects your personal information.`}
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              <p className="text-[1.6rem] text-muted-foreground leading-relaxed">
                At {SITE_PUBLISHER}, we respect your privacy and are committed
            ...
            <div className="mb-12">
              ...
              <div className="text-[1.6rem] leading-relaxed space-y-4">
                ...
                <ul className="list-disc pl-8 space-y-2 text-muted-foreground">
                  ...
                  <li>
                    Contact information when you submit inquiries through our
                    contact form
                  </li>
                  <li>
                    Any other information you choose to provide when
            ...
            <div className="mb-12">
              ...
              <div className="text-[1.6rem] leading-relaxed space-y-4">
                ...
                <ul className="list-disc pl-8 space-y-2 text-muted-foreground">
                  <li>
                    Send you newsletters and updates about our programs,
                    exhibits, and news
                  </li>
